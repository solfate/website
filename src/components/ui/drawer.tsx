    ...
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          (!direction || direction == "bottom") && "bottom-0 mt-24 inset-x-0",
          direction == "right" && "top-0 right-0 w-screen h-full !max-w-80",
          direction == "left" && "top-0 left-0 w-screen h-full !max-w-80",
          className,
        )}
        {...props}
      >
